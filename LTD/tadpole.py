...
class Tadpole:
    ...
    def integrand(self, z):
        ...
        # integrand
        I = phase_space * -1 / 2 * (1/q_plus - 1/q_UV_plus * (1 + (self.mu_UV**2 - self.m**2)/(2 * q_UV_plus**2)))
        return I*J
